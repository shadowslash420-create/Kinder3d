...
import { Search, Eye, Map, LogOut, Home } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-xl md:text-2xl font-bold text-slate-900">Staff A - Orders Management</h1>
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-4 md:space-y-6">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-xl md:text-2xl font-bold text-slate-900">Orders</h2>
