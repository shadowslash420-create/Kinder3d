...
import { Eye, Check, Trash2, Mail, LogOut, Home, ArrowLeft } from "lucide-react";
import { contactService, type ContactMessage } from "@/lib/firebase";

export default function StaffBMessages() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-amber-100">
      <nav className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-amber-600">Staff B - Messages</h1>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="space-y-6">
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Contact Messages</h2>
