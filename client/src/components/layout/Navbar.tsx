  ...
  return (
    <header
      style={{
        ...
        padding: isScrolled ? '12px 32px 80px' : '32px 32px 160px',
        transition: 'padding 0.3s ease, clip-path 0.3s ease',
        boxShadow: '0 4px 20px rgba(74, 55, 40, 0.4)',
        clipPath: isScrolled ? 'polygon(0 0, 200% -150%, 80% 100%, 0 30%)' : 'polygon(0 0, 200% -350%, 80% 100%, 0 30%)',
      }}
    >
